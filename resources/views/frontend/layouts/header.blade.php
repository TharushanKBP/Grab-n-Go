        ...
        <div class="container">
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar" id="bigshopNav">
                    ...
                    <!-- Nav Brand -->
                    <a href="index.html" class="nav-brand"><img src="{{asset('frontend/assets/img/core-img/logo.png')}}" alt="logo"></a>
                    ...
                    <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{asset('frontend/assets/img/product-img/top-1.png')}}" class="cart-thumb" alt="">
                                            </a>
                                            <div>
                        ...
                        <div class="account-area">
                            <div class="user-thumbnail">
                                <img src="{{asset('frontend/assets/img/bg-img/user.jpg')}}" alt="">
                            </div>
